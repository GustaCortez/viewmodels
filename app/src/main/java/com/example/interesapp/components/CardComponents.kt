...
//utilizamos la funcion creada, enviando los paramametros para mostrar la informacion //del interes
...
//utilizamos la funcion creada, enviando los paramametros para mostrar la informacion //de las cuotas
    SpaceW(10.dp)
